...
##### CMake
CMake is Geowars build system. You will need CMake 3.25 or later installed on your machine to build Geowars from source. Directions on how to install CMake can be found [here](https://cmake.org/download).
